...
public class SparkMotorFactory {
    ...
    public static MotorIOSparkFlex createMotorSparkFlex(SparkMotorConfiguration configuration) {
        ...
        configureWithRetry(() -> motor.setSoftLimit(SoftLimitDirection.kForward, configuration.softLimitForward), errorAlert);
        configureWithRetry(() -> motor.setSoftLimit(SoftLimitDirection.kReverse, configuration.softLimitReverse), errorAlert);

        configureWithRetry(() -> controller.setPositionPIDWrappingEnabled(configuration.positionPIDWrapping), errorAlert);
        configureWithRetry(() -> controller.setPositionPIDWrappingMinInput(configuration.positionPIDWrappingMinInput), errorAlert);
        configureWithRetry(() -> controller.setPositionPIDWrappingMaxInput(configuration.positionPIDWrappingMaxInput), errorAlert);
