...
public class StreamDeck {
    ...
    public static enum StreamDeckButton {
        ...
        kLeftClimbButton(0, 1, "Controls/LeftClimbButton", "RaiseArmIcon", "Left Climb"),
        kRightClimbButton(2, 1, "Controls/RightClimbButton", "LowerArmIcon", "Right Climb"),
        kCenterClimbButton(1, 1, "Controls/CenterClimbButton", "StopArmIcon", "Center Climb"),
