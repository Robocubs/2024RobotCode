...
public class RobotLEDStates {
    ...
    public static final LEDState kDisabledRed = new LEDState(Color.kRed, LEDPattern.BLINK);
    public static final LEDState kDisabledBlue = new LEDState(Color.kBlue, LEDPattern.BLINK);
